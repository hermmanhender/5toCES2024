...
from eprllib.postprocess.marl_init_conventional import init_rb_HVAC_DualSetPoint_evaluation
from eprllib.tools.rewards import normalize_reward_function
from eprllib.tools.action_transformers import thermostat_dual
from numpy.random import choice
import gymnasium as gym

name = "CES2024_LSTM_PPO_DualSetPointHVAC"
...
env_config={
    ...
    "weather_prob_days": 2,
    # Action transformer
    'action_transformer': thermostat_dual,
...
# beta 0.5
checkpoint_path = 'C:/Users/grhen/ray_results/20240604190632_DualSetPointHVAC_marl_PPO/DualSetPointHVAC_beta05_PPO_cb110_00000/checkpoint_000027'
...
add_name = 'rb_beta05'
init_rb_HVAC_DualSetPoint_evaluation(
    env_config=env_config,
